...
namespace Projecto3MVC.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SupplierId,CompanyName,ContactName,ContactTitle,Address,City,PostalCode,Country,Phone,Fax")] Supplier supplier)
        {
