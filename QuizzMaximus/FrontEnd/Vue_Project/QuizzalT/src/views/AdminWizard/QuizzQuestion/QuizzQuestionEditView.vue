<template>
  <div class="container">
    ...
    <form @submit.prevent="quizzQuestionUpdate()">
      ...
      <button @click="back(quizzQuestion.quizzId, quizzQuestion.questionId)">Back</button>
    </form>
...
export default defineComponent({
  ...
  methods: {
    ...
    back(quizzId: number, questionId: number) {
      this.$router.push(`/quizzQuestionDetails/${quizzId},${questionId}`);
    }
  },
  mounted() {
