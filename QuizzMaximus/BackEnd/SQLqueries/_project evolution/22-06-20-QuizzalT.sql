...
VALUES
	('MyAdmin',  'Admin@email.com',     'Admin', '123qwerty'),
	(   'Igor',   'Igor@email.com', 'Moderator', '123qwerty'),
	(    'Ivo',    'Ivo@email.com', 'Moderator', '123qwerty'),
	(   'João',   'Joao@email.com', 'Moderator', '123qwerty'),
	( 'Rafael', 'Rafael@email.com', 'Moderator', '123qwerty'),
	('JohnDoe',  'JohnD@email.com',    'Player', '123qwerty'),
	(  'Dummy',  'Dummy@email.com',    'Player', '123qwerty'),
	(   'HALL',   'HALL@email.com',    'Player', '123qwerty'),
	( 'Doctor',    'Who@email.com',    'Player', '123qwerty');
GO
...
VALUES
	...
	( 1,  1,                                       'Dummy Dummy Dummy Dummy Dummy Dummy Dummy', 3, 30,     'Draft');
GO
